...
<html lang="en">
  ...
  <body class="bg-light">
    ...
    <section class="prd-isplay">
      <div class="prd-slider-contents">
        <div class="texts">
          ...
          <h2>Welcome to ARE - See All Super Market Related Products.</h2>
        </div>
            ...
            <table class="table table-hover text-center">
                <thead class="bg-dark text-light" >
                    <tr>
                        ...
                        <th width="10%" scope="col">Relation ID</th>
    ...
    <div class="modal-dialog">
        <form action="./backEnd/smrelatedproductsCrud.php" method="POST" enctype="multipart/form-data" >
            ...
            <div class="modal-body">
                ...
                <div class="input-group mb-3">
                    ...
                    <select name="url" id="url">
                      ...
                      <option value="refridgerationCabinets.php">Refridgeration Cabinets</option>
                      <option value="supermarketSingle.php">Single Product</option>
                    </select>
                </div>
                ...
                <div class="input-group mb-3">
                    <span class="input-group-text" >Relation ID</span>
                    <input type="number" class="form-control" name="relationid" id="relationid" required >
                </div>
                <div class="input-group mb-3">
        ...
        <div class="modal-dialog">
            <form action="./backEnd/smrelatedproductsCrud.php" method="POST" enctype="multipart/form-data" >
                ...
                <div class="modal-body">
                    ...
                    <div class="input-group mb-3">
                        <span class="input-group-text" >Relation ID</span>
                        <input type="text" class="form-control" name="editrelationid" id="editrelationid" required >
                    </div>
    ...
    <?php 
      ...
      if(isset($_GET['edit']) && $_GET['edit']>0) {
        ...
        $query = "SELECT * FROM `smrelatedproducts` WHERE `id` = '$_GET[edit]'";
        $result = mysqli_query($conn, $query);
        ...
        document.querySelector('#editrelationid').value=`$fetch[relationid]`;
    ...
    <script>
      function confirm_rem(id){
        if(confirm("Are you sure you want to delete this item?")) {
          window.location.href="./backEnd/supermarketCrud.php?rem="+id;
        }
      }
    </script>
