...
<html lang="en">
  ...
  <body class="bg-light">
    ...
    <section class="prd-isplay">
      <div class="prd-slider-contents">
        <div class="texts">
          ...
          <h2>Welcome to ARE - See All Refridgeration Cabinets.</h2>
        </div>
        ...
        <div class="project-contents">
            ...
            <table class="table table-hover text-center">
                ...
                <tbody class="bg-white">
                  ...
                  $query = "SELECT * FROM `refridgerationcabinets`";
                  $result = mysqli_query($conn, $query);
                  $i=1;
                  $fetchprd_src = FETCHPRD_SRC;

                  while($fetch = mysqli_fetch_assoc($result)) {
                    echo<<<refridgerationcabinets
    ...
    <div class="modal-dialog">
        <form action="./backEnd/refridgerationcabinetsCrud.php" method="POST" enctype="multipart/form-data" >
            ...
            <div class="modal-body">
                ...
                <div class="input-group mb-3">
                    ...
                    <select name="url" id="url">
                      <option value="compressors.php">Compressors</option>
                      <option value="supermarket.php">Super Market</option>
                      <option value="refridgerationcabinetsSingle.php">Single Product</option>
                    </select>
                </div>
    ...
    <?php 
      ...
      if(isset($_GET['edit']) && $_GET['edit']>0) {
        ...
        $query = "SELECT * FROM `refridgerationcabinets` WHERE `id` = '$_GET[edit]'";
        $result = mysqli_query($conn, $query);
...
<!--Java Scripts Starts -->
    ...
    <script>
      function confirm_rem(id){
        if(confirm("Are you sure you want to delete thi sitem?")) {
          window.location.href="./backEnd/refridgerationcabinetsCrud.php?rem="+id;
        }
      }
    </script>
