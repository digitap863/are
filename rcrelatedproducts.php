...
<html lang="en">
  ...
  <body class="bg-light">
    ...
    <section class="prd-isplay">
      <div class="prd-slider-contents">
        <div class="texts">
          ...
          <h2>Welcome to ARE - See All Refridgeration Cabinets Related Products.</h2>
        </div>
        ...
        <div class="project-contents">
            ...
            <table class="table table-hover text-center">
                ...
                <tbody class="bg-white">
                  ...
                  $query = "SELECT * FROM `rcrelatedproducts`";
    ...
    <div class="modal-dialog">
        <form action="./backEnd/rcrelatedproductsCrud.php" method="POST" enctype="multipart/form-data" >
    ...
    <?php 
      ...
      if(isset($_GET['edit']) && $_GET['edit']>0) {
        ...
        $query = "SELECT * FROM `rcrelatedproducts` WHERE `id` = '$_GET[edit]'";
        $result = mysqli_query($conn, $query);
