...
<html lang="en">
  ...
  <body class="bg-light">
    ...
    <section class="prd-isplay">
      <div class="prd-slider-contents">
        <div class="texts">
          ...
          <h2>Welcome to ARE - See All Super Market Products.</h2>
        </div>
    ...
    <div class="modal-dialog">
        <form action="./backEnd/supermarketCrud.php" method="POST" enctype="multipart/form-data" >
    ...
    <?php 
      ...
      if(isset($_GET['edit']) && $_GET['edit']>0) {
        ...
        $query = "SELECT * FROM `supermarket` WHERE `id` = '$_GET[edit]'";
        $result = mysqli_query($conn, $query);
