...
<html lang="en">
  <head>
    ...
    <title>ARE Refridgeration Cabinets</title>

    <!--CSS Files-->
    <link rel="stylesheet" href="./css/refridgeration.css" />
            ...
            <div class="prd-wrapper">
              <?php 
                ...
                while($fetch = mysqli_fetch_assoc($result)) {
                  if ($fetch['url'] === 'refridgerationcabinetsSingle.php') {
                    // Store product data in session
                     $_SESSION['product_id'] = $fetch['id'];
                    $product_url = 'refridgerationcabinetsSingle.php';
                } else {
