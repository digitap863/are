...
<html lang="en">
  ...
  <body class="bg-light">
    ...
    <section class="prd-isplay">
      <div class="prd-slider-contents">
        <div class="texts">
          ...
          <h2>Welcome to ARE - See All Products.</h2>
        </div>
    ...
    <div class="modal-dialog">
        <form action="./backEnd/prdCrud.php" method="POST" enctype="multipart/form-data" >
            ...
            <div class="modal-body">
                ...
                <div class="input-group mb-3">
                    ...
                    <select name="url" id="url">
                      ...
                      <option value="singleProduct.php">Single Product</option>
                    </select>
                </div>
    ...
    <script>
      function confirm_rem(id){
        if(confirm("Are you sure you want to delete thi sitem?")) {
          window.location.href="./backEnd/prdCrud.php?rem="+id;
        }
      }
    </script>
